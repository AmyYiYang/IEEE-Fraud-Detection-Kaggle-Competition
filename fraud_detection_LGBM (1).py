...
files = ['train_merge.csv', 'test_merge.csv']
...
useful_features = ['TransactionAmt', 'ProductCD', 'card1', 'card2', 'card3', 'card4', 'card5', 'card6', 'addr1', 'addr2', 'dist1',
                   ...
                   'V324', 'V326',
                   'V329', 'V331', 'V332', 'V333', 'V335', 'V336', 'V338', 'id_01', 'id_02', 'id_03', 'id_05', 'id_06',
                   'id_09',
                   'id_11', 'id_12', 'id_13', 'id_14', 'id_15', 'id_17', 'id_19', 'id_20', 'id_30', 'id_31', 'id_32',
                   'id_33',
...
#ECDF for fraudlent transaction Amount
temp1 = np.sort(train[train['isFraud']==1]['TransactionAmt'])
temp2 = np.arange(1,len(temp1)+1) / len(temp1)
plt.figure(figsize=(16,10))
plt.plot(temp1,temp2,marker='.',linestyle='none')
plt.margins(0.02)
...
#ECDF for non-fraudlent transaction Amount
temp1 = np.sort(train[train['isFraud']==0]['TransactionAmt'])
temp2 = np.arange(1,len(temp1)+1) / len(temp1)
plt.figure(figsize=(16,10))
plt.plot(temp1,temp2,marker='.',linestyle='none')
plt.margins(0.02)
...
#Plotting countplot for isFraud column
plt.figure(figsize=(20,20))
sns.heatmap(data=train.corr().abs())
...
sample_submission.to_csv('submission_2209.csv', index=False)
